...
- Beide Grafiken zeigen die vier Modelle: On-Premises (Vor-Ort), Infrastructure as a Service (IaaS), Platform as a Service (PaaS) und Software as a Service (SaaS).
- In beiden wird deutlich: Je weiter man in Richtung SaaS geht, desto mehr übernimmt der Cloud-Anbieter (z. B. Microsoft) die Verantwortung.
...
- Farbcode: Blau = Du kümmerst dich selbst darum, Rot = Anbieter übernimmt.
...
- Farbcode: Dunkelblau = Kunde, Hellblau = Anbieter, Halb-Hellblau = Geteilt
